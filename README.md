...
```bash
curl -L https://github.com/bfi-de/ngsild-grafana-datasource/releases/download/v1.2.1/ngsild-grafana-datasource-1.2.1.tgz --output ngsild-grafana-datasource-1.2.1.tgz
tar -zxvf ngsild-grafana-datasource-1.2.1.tgz
...
```bash
grafana cli --pluginUrl https://github.com/bfi-de/ngsild-grafana-datasource/releases/download/v1.2.1/ngsild-grafana-datasource-1.2.1.zip plugins install ngsild-grafana-datasource
```
...
```bash
docker exec grafana-dev grafana cli --pluginUrl https://github.com/bfi-de/ngsild-grafana-datasource/releases/download/v1.2.1/ngsild-grafana-datasource-1.2.1.zip plugins install ngsild-grafana-datasource
```
